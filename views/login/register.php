                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <div class="alert-danger">
                            <?php
                            if(isset($_COOKIE['er_register'])){

                                echo "<p style='color:#d52a1a'>" .$_COOKIE['er_register']. "</p>";
                            }
                            ?>
                        </div>
                        <form class="user" method="POST" action="?view=login&&act=register">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" name = "re_password"  class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Nhập lại mật khẩu:" >
                                </div>
                                <?php
