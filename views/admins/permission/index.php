                            ...
                            <ul class="pagination">
                                ...
                                <li class="page-item" <?php if($page <= 1){ echo "class='disabled'"; } ?>>
                                    <a class="page-link" <?php if($page > 1){
                                        echo "href='?view=admin&&act=list_permission&&page=$previous_page'";
                                    } ?>>Previous</a>
                                </li>
                                ...
                                if ($total_pages){
                                    for ($counter = 1; $counter <= $total_pages; $counter++){
                                        if ($counter == $page) {
                                            ...
                                            echo "<li class='page-item'><a class='page-link' href='?view=admin&&act=list_permission&&page=$counter'>$counter</a></li>";
                                        }
                                    }
                                }
                                ?>
                                ...
                                <li class="page-item" <?php if($page >= $total_pages){
                                    ...
                                    <a class="page-link" <?php if($page < $total_pages) {
                                        echo "href='?view=admin&&act=list_permission&&page=$next_page'";
                                    } ?>>Next</a>
                                </li>
                            </ul>
                        </nav>
