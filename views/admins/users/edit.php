            ...
            <div class="container">
                ...
                <form class="user" method="POST" action="?view=admin&act=update_user&&id=<?= $data[0]['id'] ?>">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" name = "phone" value="<?= $data[0]['phone'] ?>" class="form-control form-control-user" id="exampleLastName" placeholder="Số điện thoại:" required="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="text" name = "address"  value="<?= $data[0]['address'] ?>" class="form-control form-control-user" id="exampleInputEmail" placeholder="Địa chỉ:" required="required">
                    </div>
                    <div class="form-group">
