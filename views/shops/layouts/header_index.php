...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="public/shops/styles/main_styles.css">
    <link rel="stylesheet" type="text/css" href="public/shops/styles/responsive.css">
</head>
<body>
    ...
    <header class="header">
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                ?>
<!--                <div class="user"><a href="?view=login&&act="><div><img src="public/shops/images/user.svg" alt="https://www.flaticon.com/authors/freepik"><div>1</div></div></a></div>-->
                <!-- Phone -->
